...
timer_sleep (int64_t ticks) 
{
  ...
  cur->wakeup_ticks = timer_ticks() + ticks;  // Set the wakeup time for the thread

  list_insert_ordered(&sleep_list, &cur->elem, thread_compare_wakeup, NULL);  // Add the thread to the sleep list
